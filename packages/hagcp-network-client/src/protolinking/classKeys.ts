export const enum ClassKeys {
    ...
    zipchunk = "zipchunk",
    login2_begin = "login2_begin",
    QueryServerInfo = "QueryServerInfo",
    login2_challenge = "login2_challenge",
    login2_response = "login2_response",
    login2_result = "login2_result",
    subscribeplayerview = "subscribeplayerview",
    unsubscribeplayerview = "unsubscribeplayerview",
    subscribecommandnodeview = "subscribecommandnodeview",
    SubscribeHostingCenterInfoView = "SubscribeHostingCenterInfoView",
    subscribefriendview = "subscribefriendview",
    SubscribeShopView = "SubscribeShopView",
    subscribeignoredplayerview = "subscribeignoredplayerview",
    SubscribeMessageView = "SubscribeMessageView",
    subscribewarmaplightview = "subscribewarmaplightview",
    subscribebattlesview = "subscribebattlesview",
    subscriberesourceview = "subscriberesourceview",
    QueryShopWarBondItemsRequest = "QueryShopWarBondItemsRequest",
    QueryShopWarBondItemsResponse = "QueryShopWarBondItemsResponse",
    GetChatChannelsSubscribedRequest = "GetChatChannelsSubscribedRequest",
    GetChatChannelsSubscribedResponse = "GetChatChannelsSubscribedResponse",
    RequestReadCharacterStats = "RequestReadCharacterStats",
    GetAssaultTeamStatsRequest = "GetAssaultTeamStatsRequest",
    GetAssaultTeamStatsResponse = "GetAssaultTeamStatsResponse",
    LoginQueueUpdate = "LoginQueueUpdate",
    subscriberesponse = "subscriberesponse",
    KeyValueChangeSet = "KeyValueChangeSet",
    QueryServerInfoResponse = "QueryServerInfoResponse",
    QueryBannedMachineRequest = "QueryBannedMachineRequest",
    QueryBannedMachineResponse = "QueryBannedMachineResponse",
    SubscribePlayerMissionViewRequest = "SubscribePlayerMissionViewRequest",
    query_war_catalogue_request = "query_war_catalogue_request",
    query_war_catalogue_response = "query_war_catalogue_response",
    login2_postlogin = "login2_postlogin",
    login2_postlogin_result = "login2_postlogin_result",
    subscribesoldierview = "subscribesoldierview",
    QueryVoucherPacksRequest = "QueryVoucherPacksRequest",
    QueryVoucherPacksResponse = "QueryVoucherPacksResponse",
    SteamQueryBundlesRequest = "SteamQueryBundlesRequest",
    SteamQueryBundlesResponse = "SteamQueryBundlesResponse",
    QueryActiveSurveyRequest = "QueryActiveSurveyRequest",
    QueryActiveSurveyResponse = "QueryActiveSurveyResponse",
    RedeemDailyLoginRewardRequest = "RedeemDailyLoginRewardRequest",
    RedeemDailyLoginRewardResponse = "RedeemDailyLoginRewardResponse",
    unsubscribecommandnodeview = "unsubscribecommandnodeview",
    unsubscribewarmapview = "unsubscribewarmapview",
    unsubscriberesourceview = "unsubscriberesourceview",
    UnsubscribePlayerMissionViewRequest = "UnsubscribePlayerMissionViewRequest",
    unsubscribebattlesview = "unsubscribebattlesview",
    unsubscriberesponse = "unsubscriberesponse",
    unsubscribewarmaplightview = "unsubscribewarmaplightview",
    subscribewarmapview = "subscribewarmapview",
    GetMissionDetailsRequest = "GetMissionDetailsRequest",
    GetMissionDetailsResponse = "GetMissionDetailsResponse",
    transport_commandnode = "transport_commandnode",
    transport_commandnode_response = "transport_commandnode_response",
    keepaliverequest = "keepaliverequest",
    keepalive = "keepalive",
    keepaliveresponse = "keepaliveresponse",
    query_commandnode_owner = "query_commandnode_owner",
    query_commandnode_owner_response = "query_commandnode_owner_response",
    GetGoldPricesRequest = "GetGoldPricesRequest",
    GetGoldPricesResponse = "GetGoldPricesResponse",
    JoinMatchMakingRequest = "JoinMatchMakingRequest",
    JoinMatchMakingResponse = "JoinMatchMakingResponse",
    CancelJoinMatchMakingRequest = "CancelJoinMatchMakingRequest",
    CancelJoinMatchMakingResponse = "CancelJoinMatchMakingResponse",
    ResponseReadCharacterStats = "ResponseReadCharacterStats",
    GetBattleReportRequest = "GetBattleReportRequest",
    GetBattleReportResponse = "GetBattleReportResponse",
    join_war_response = "join_war_response",
    ...
    AdminToolPlayerStatRequest = "AdminToolPlayerStatRequest",
    AdminToolPlayerStatResponse = "AdminToolPlayerStatResponse",
    AdminToolGetDbInfoRequest = "AdminToolGetDbInfoRequest",
    RequestEarnings = "RequestEarnings",
    ResponseEarnings = "ResponseEarnings",
    GetHandlerTypes = "GetHandlerTypes",
    ResponseHandlerTypes = "ResponseHandlerTypes",
    AddMembershipRequest = "AddMembershipRequest",
    AddMembershipResponse = "AddMembershipResponse",
    ChangeTierRequest = "ChangeTierRequest",
    ChangeTierResponse = "ChangeTierResponse",
    DebugGetWarCatalogueRequest = "DebugGetWarCatalogueRequest",
    MonitorLoadRequest = "MonitorLoadRequest",
    MonitorLoadResponse = "MonitorLoadResponse",
    war_create_request = "war_create_request",
    war_create_response = "war_create_response",
    delete_mission = "delete_mission",
    delete_mission_response = "delete_mission_response",
    EndMissionRequest = "EndMissionRequest",
    EndMissionResponse = "EndMissionResponse",
    SetSquadMatchMakingFlagRequest = "SetSquadMatchMakingFlagRequest",
