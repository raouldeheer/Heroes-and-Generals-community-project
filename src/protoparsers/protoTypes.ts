...
export const SetProtoParsers = new Map<string, protobuf.Type>([
    ...
    [KeyValueChangeKey.accesspointtemplate, Protos.lookupType("War.accesspointtemplate")],
    ...
    [KeyValueChangeKey.battlefield, Protos.lookupType("War.battlefield")],
    ...
    [KeyValueChangeKey.UnlockNotification, Protos.lookupType("Player.UnlockNotification")],
    ...
    [KeyValueChangeKey.PlayerGoldOffer, Protos.lookupType("Player.PlayerGoldOffer")],
]);
